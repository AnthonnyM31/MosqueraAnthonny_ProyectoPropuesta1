...
namespace MosqueraAnthonny_ProyectoPropuesta1.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreUsuario,Puntos")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreUsuario,Puntos")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
